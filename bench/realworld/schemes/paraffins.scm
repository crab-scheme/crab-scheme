; Paraffins — from r7rs-benchmarks.
; Counts paraffin isomers; tree allocation + structural sharing.
;
; Sourced: https://github.com/ecraven/r7rs-benchmarks/blob/master/src/paraffins.scm
