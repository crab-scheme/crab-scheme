; Maze — from r7rs-benchmarks (Olin Shivers).
; Hexagonal-grid maze generator: random recursion + bitwise ops.
; Default 20x7 grid; result is a list of characters.
;
; Sourced: https://github.com/ecraven/r7rs-benchmarks/blob/master/src/maze.scm
; (import ...) line stripped; run-benchmark replaced with realworld-bench.
