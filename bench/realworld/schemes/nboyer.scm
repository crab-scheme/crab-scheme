; nboyer — Boyer-Moore theorem prover (no-sharing variant).
; GC stress; standard Larceny/Gabriel benchmark.
; Sourced: https://github.com/ecraven/r7rs-benchmarks/blob/master/src/nboyer.scm
; (import ...) stripped; run-benchmark replaced; (define (f . args)) forms
; rewritten as (define f (lambda args ...)) for CrabScheme expander compat.
...
(define setup-boyer (lambda args #t));; assigned below
(define test-boyer (lambda args #t));; assigned below
...
(realworld-bench
  "nboyer"
  '((n . 3))
  (lambda () (setup-boyer) (test-boyer alist term 3)))
