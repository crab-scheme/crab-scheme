; sboyer — Boyer-Moore theorem prover (sharing-aware variant).
; GC stress from long-lived shared cons cells. Sourced from
; https://github.com/ecraven/r7rs-benchmarks/blob/master/src/sboyer.scm
; (import ...) stripped; run-benchmark replaced.
