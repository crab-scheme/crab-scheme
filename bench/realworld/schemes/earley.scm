; earley — Earley parser; sustained allocation + complex linked data.
; Sourced: https://github.com/ecraven/r7rs-benchmarks/blob/master/src/earley.scm
; (import ...) stripped; run-benchmark replaced. n=10 (canonical is 15,
; reduced so 1 iter is under a minute on CrabScheme VM).
...
(realworld-bench
  "earley"
  '((n . 10))
  (lambda () (test (vector->list (make-vector 10 (quote a))))))
