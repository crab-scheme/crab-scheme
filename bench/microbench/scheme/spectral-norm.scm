; Spectral norm — Computer Language Benchmarks Game.
; Computes the spectral norm of a Hilbert-like matrix using the power
; method. Tests floating-point arithmetic + vector access.
;
; Default N = 100 (output is the norm to 9 decimal places).
...
(define n 50)
(display "spectral-norm(") (display n) (display ") = ")
(display (spectral-norm n))
(newline)
