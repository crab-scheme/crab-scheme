...
#[test]
fn vm_conformance_r7rs_environments() {
    let walker = pass_count_walker("r7rs_environments.scm");
    let vm = pass_count_vm("r7rs_environments.scm").expect("vm should run r7rs_environments.scm");
