...
| M6        | JIT abstraction + Cranelift backend  | `jit-cranelift`        | JIT speedup ≥ 5× over interpreter on Gabriel benchmarks    | ✅ Phase 1–5 done (`m6-phase5-complete`); Gabriel geomean **2.31×** as of 2026-05-16 (up from 1.74× baseline) — gate NOT met, architectural rework or ADR reframe pending (see `docs/milestones/m6-phase5-exit.md`) |
